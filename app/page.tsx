...
function BarberCalendarCore() {
  ...
  const onTouchMove = (e: React.TouchEvent<HTMLDivElement>) => {
    ...
    // Once we’ve decided this gesture is a vertical scroll, never re-evaluate into a day-swipe.
  ...
  const onTouchEnd = () => {
    ...
    // Scroll gesture: let native scrolling do its thing; don’t trigger snap animations.
